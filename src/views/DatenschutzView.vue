  ...
  <main class="section">
    <div class="container narrow">
      ...
      <article class="text-card">
        ...
        <p>
          CampusWette ist ein studentisches Lehrprojekt. Die Anwendung dient der
          Demonstration einer Web-Applikation aus dem betriebswirtschaftlichen
          Hochschulumfeld.
        </p>
        ...
        <p>
          Das Kontaktformular öffnet über einen mailto-Link das lokale
          E-Mail-Programm. Die Nachricht wird dabei nicht automatisch durch die
          Anwendung auf einem Server gespeichert.
        </p>
