    ...
    <div class="container">
      <header class="page-header">
        ...
        <p class="section-intro">
          Hier findest du deine Quiz-Teilnahmen, deinen Punktestand und deine
          ECTS-Anträge.
        </p>
      </header>
      ...
      <template v-else-if="profile">
        ...
        <section class="cards dashboard-cards">
          <article class="card">
            ...
            <p>
              Bearbeite deine persönlichen Daten und prüfe deine Accountdaten.
            </p>
  ...
  methods: {
    async loadProfile() {
      ...
      try {
        ...
        this.errorMessage =
          "Das Student-Dashboard konnte nicht geladen werden.";
        console.error(error);
      } finally {
